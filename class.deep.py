...
class Account ():
    ...
    # __owner o'zgaruvchisini yangilash uchun yangi qiymat kiritish mumkin.
    @holder.setter
...
try:
    # error chiqarish uchun qildik, aslida bu private bolgani uchun tashqaridan togrida togri chaqira olmaymiz
...
# bu (holder) setter methodini chaqiradi va __owner ozgaruvchini yangilab beradi
